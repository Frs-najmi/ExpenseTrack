  ...
  <div class="container-fluid">
    <div class="row vh-100">
      <div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary shadow-lg" style="width: 280px;">
        <a href="main-page.php" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
          ...
          <li class="mb-1"> <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0"
            ...
            <div class="collapse show" id="dashboard-collapse" >
              <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                <li><a href="expenses.html" class=" d-inline-flex rounded text-decoration-none nav-link active" aria-current="page ">Add Expenses</a></li>
                <li><a href="view_expense copy.php" class="link-body-emphasis d-inline-flex text-decoration-none rounded">View Expenses</a></li>
                </ul>
            </div>
          </li>
          <li>
        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu text-small shadow">
            ...
            <li><a class="dropdown-item btn"  href="../logout.php">Sign out</a></li>
          </ul>
        </div>
      </div>
    ...
    <div class="container-expenses col-7 m-4  p-4 ps-3 container">
      ...
      <form class="card p-4 shadow-sm " action="add_expense.php" method="post">
        <div class="mb-3"></div>
        <label for="expenseName" class="form-label">Expense Name</label>
        <input type="text" class="form-control" id="expenseName" name="expense_name" placeholder="e.g. Groceries" required>

        <div class="mb-3">
          <label for="expenseAmount" class="form-label">Amount</label>
          <input type="number" class="form-control" id="expenseAmount" name="expense_amount" placeholder="e.g. 50" min="0" step="0.01"
            required>
        </div>
        <div class="mb-3">
